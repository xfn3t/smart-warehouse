...
public class InventoryHistoryQueryHelper {
    ...
    public Double calculateAvgMinutesSafe(
        Specification<InventoryHistory> spec
    ) {
        CriteriaBuilder cb = em.getCriteriaBuilder();
        CriteriaQuery<InventoryHistory> cq = cb.createQuery(
        ...
        try {
            ...
            double totalMinutes = results
                .stream()
                .mapToLong(history -> {
                    if (
                        history.getScannedAt() == null ||
